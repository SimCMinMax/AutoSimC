...
if config.has_option('Gear', 'shoulder'): c_shoulders=gear['shoulder']
c_back=gear['back']
c_chest=gear['chest']
if config.has_option('Gear', 'wrists'): c_shoulders=gear['wrists']
if config.has_option('Gear', 'wrist'): c_shoulders=gear['wrist']
c_hands=gear['hands']
c_waist=gear['waist']
c_legs=gear['legs']
c_feet=gear['feet']
